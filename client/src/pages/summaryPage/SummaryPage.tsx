...
export default function SummaryPage() {
  ...
  const fetchVaccin = async () => {
    const vaccinatedPateients =
      await vaccinationRequests.getAllVaccinatedPatients();
    ...
    if (vaccinatedPateients && patients) {
      ...
      setVaccinData([
        {
          id: 0,
          value: numOfPatients - numOfVaccinatedPatients,
          color: "blue",
          label: "unvaccinated patients",
        },
        {
          id: 1,
          value: numOfVaccinatedPatients,
          color: "red",
  ...
  return (
    <Stack
      spacing={2}
      sx={{ width: { xs: "100%", sm: "100%" }, display: "flex" }}
    >
      <Typography
        variant="h1"
        sx={{
